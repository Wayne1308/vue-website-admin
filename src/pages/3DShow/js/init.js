...
// 资源
import waterJpg from '../objs/waternormals.jpg';
// import transportShipMtl from "/static/objs/transportShip.mtl?raw";
...
// ===============  初始化摄像头 ================
function initCamera() {
  camera = new THREE.PerspectiveCamera(30, 500 / 500, 0.1, 1000); //相机构建
...
function initObjModel() {
  ...
  // });
  // 运输船
  // const transportShipMtl = new URL('../objs/transportShip.mtl?raw', import.meta.url)
  mtlLoader.setPath('static/objs/');
  mtlLoader.load('transportShip.mtl', function (materials) {
    materials.preload();
    var objLoader = new THREE.OBJLoader();
    objLoader.setMaterials(materials);
    objLoader.setPath('static/objs/');
    objLoader.load('transportShip.obj', function (object) {
      object.position.x = 0;
      object.position.z = 0;
      object.position.y = 0;
  ...
  water = new THREE.Water(
    waterGeometry,
    {
      textureWidth: 100,
      textureHeight: 100,
      waterNormals: new THREE.TextureLoader().load(waterJpg , function ( texture ) {
