		...
		<el-scrollbar :max-height="height*0.8-200">
			<el-form :model="addDialogForm.form" ref="addDialogForm" :rules="addDialogForm.rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="职业" :label-width="120">
							<el-input v-model="addDialogForm.form.job" placeholder="请输入职业" autocomplete="off"
								style="width:58%" />
						</el-form-item>
					</el-col>
				</el-row>
		...
		methods: {
			...
			show:function(data){
				...
				setTimeout(function() {
					...
					that.addDialogForm.editor.config.placeholder = '请输入简介内容';
					// 配置服务器端地址
