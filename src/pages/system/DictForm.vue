	...
	<el-dialog v-model="addDialogForm.visible" title="添加数据" center draggable destroy-on-close width="80%">
		<el-scrollbar :max-height="height*0.8-200">
			<el-form :model="addDialogForm.form" ref="addDialogForm" :rules="addDialogForm.rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="名称" :label-width="120">
							<el-input v-model="addDialogForm.form.name" required placeholder="请输入名称" autocomplete="off"
								style="width:58%" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="标识" :label-width="120">
							<el-input v-model="addDialogForm.form.key" required placeholder="请输入标识" autocomplete="off"
								style="width:58%" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="文本" :label-width="120">
							<el-input v-model="addDialogForm.form.label" required placeholder="请输入文本" autocomplete="off"
								style="width:58%" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="值" :label-width="120">
							<el-input v-model="addDialogForm.form.value" required placeholder="请输入值" autocomplete="off"
								style="width:58%" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="顺序" :label-width="120">
							<el-input type="number" v-model="addDialogForm.form.sort_" required placeholder="请输入顺序" autocomplete="off"
								style="width:58%" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
